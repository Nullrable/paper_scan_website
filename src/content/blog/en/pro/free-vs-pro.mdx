...
Pro is sold exclusively through the App Store and Google Play. Paper Scanner does not process payment credentials directly. Subscriptions auto-renew until cancelled. Cancellation is a single action in the device's subscription settings — no contact with the development team is required. Refunds follow the standard policies of the respective app store.

Regional pricing is determined by App Store and Google Play tier structures.
